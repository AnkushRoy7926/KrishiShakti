...
const AuthLayout = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="grid grid-cols-1 overflow-clip md:grid-cols-2">
      <div className="bg-green-dark hidden h-screen items-start justify-center overflow-clip px-10 md:flex md:flex-col dark:bg-[linear-gradient(to_right_bottom,#0d1b2a,#1b263b,#415a77,#778da9,#e0e1dd)]">
        ...
        <h1 className="text-green-mindaro text-6xl font-bold dark:text-blue-100">
          One KrishiID. <br />
          All of KrishiShakti.
        </h1>
        <p className="text-green-mindaro/80 mt-16 font-bold dark:text-blue-100/80">
          Manage your business with ease. One account, all of your favorite
          services.
        </p>
      </div>
      <div className="bg-green-mindaro/40 flex h-screen flex-col items-center overflow-auto p-4 py-8">
        {children}
        <p className="flex flex-row items-center gap-2 p-3 text-sm">
          <IconLockCheck className="h-5" />
          Your KrishiID is encrypted and securely stored.
        </p>
      </div>
    </div>
  );
